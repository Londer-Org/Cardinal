...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      // Spread conditionally rather than passing `checked` unconditionally:
      // Cardinal compiles with exactOptionalPropertyTypes, under which passing
      // an explicit `undefined` is not the same as omitting the prop.
